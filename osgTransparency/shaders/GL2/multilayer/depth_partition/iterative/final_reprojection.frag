...
uniform sampler2DRect codedPreviousIntervalsTextures[POINTS / 4 + 1];
...
void main()
{
    ...
    float full_width = (abs_max - abs_min) * FIRST_INTERVAL_SEARCH_WIDTH;
...
#ifdef PROJECT_Z
    gl_FragData[POINTS / 4][POINTS % 4] = reproject(-value);
#else
    gl_FragData[POINTS / 4][POINTS % 4] = value;
#endif
#endif
    ...
    for (int point = 0; point < POINTS; ++point)
    {
        ...
        gl_FragData[point / 4][point % 4] = value;
    }
}
